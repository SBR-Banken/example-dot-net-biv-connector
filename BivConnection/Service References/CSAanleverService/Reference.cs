...
namespace BivConnection.CSAanleverService {
    ...
    public interface AanleverService_V1_2 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://logius.nl/digipoort/wus/2.0/aanleverservice/1.2/AanleverService/aanle" +
            ...
            "Response")]
        [System.ServiceModel.FaultContractAttribute(typeof(BivConnection.CSAanleverService.foutType), Action="http://logius.nl/digipoort/wus/2.0/aanleverservice/1.2/AanleverService/aanleveren" +
            "/Fault/", Name="aanleverFault", Namespace="http://logius.nl/digipoort/koppelvlakservices/1.2/")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        BivConnection.CSAanleverService.aanleverenResponse aanleveren(BivConnection.CSAanleverService.aanleverenRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://logius.nl/digipoort/wus/2.0/aanleverservice/1.2/AanleverService/aanle" +
            "verenRequest", ReplyAction="http://logius.nl/digipoort/wus/2.0/aanleverservice/1.2/AanleverService/aanleveren" +
            "Response")]
        System.Threading.Tasks.Task<BivConnection.CSAanleverService.aanleverenResponse> aanleverenAsync(BivConnection.CSAanleverService.aanleverenRequest request);
    }
    ...
    public partial class aanleverenRequest {
        ...
        public BivConnection.CSAanleverService.aanleverRequest aanleverRequest;
        
        public aanleverenRequest() {
        }
        
        public aanleverenRequest(BivConnection.CSAanleverService.aanleverRequest aanleverRequest) {
    ...
    public partial class aanleverenResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://logius.nl/digipoort/koppelvlakservices/1.2/", Order=0)]
        public BivConnection.CSAanleverService.aanleverResponse aanleverResponse;
        
        public aanleverenResponse() {
        }
        
        public aanleverenResponse(BivConnection.CSAanleverService.aanleverResponse aanleverResponse) {
            this.aanleverResponse = aanleverResponse;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AanleverService_V1_2Channel : BivConnection.CSAanleverService.AanleverService_V1_2, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AanleverService_V1_2Client : System.ServiceModel.ClientBase<BivConnection.CSAanleverService.AanleverService_V1_2>, BivConnection.CSAanleverService.AanleverService_V1_2 {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        BivConnection.CSAanleverService.aanleverenResponse BivConnection.CSAanleverService.AanleverService_V1_2.aanleveren(BivConnection.CSAanleverService.aanleverenRequest request) {
            return base.Channel.aanleveren(request);
        }
        
        public BivConnection.CSAanleverService.aanleverResponse aanleveren(BivConnection.CSAanleverService.aanleverRequest aanleverRequest) {
            BivConnection.CSAanleverService.aanleverenRequest inValue = new BivConnection.CSAanleverService.aanleverenRequest();
            inValue.aanleverRequest = aanleverRequest;
            BivConnection.CSAanleverService.aanleverenResponse retVal = ((BivConnection.CSAanleverService.AanleverService_V1_2)(this)).aanleveren(inValue);
            return retVal.aanleverResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<BivConnection.CSAanleverService.aanleverenResponse> BivConnection.CSAanleverService.AanleverService_V1_2.aanleverenAsync(BivConnection.CSAanleverService.aanleverenRequest request) {
            return base.Channel.aanleverenAsync(request);
        }
        
        public System.Threading.Tasks.Task<BivConnection.CSAanleverService.aanleverenResponse> aanleverenAsync(BivConnection.CSAanleverService.aanleverRequest aanleverRequest) {
            BivConnection.CSAanleverService.aanleverenRequest inValue = new BivConnection.CSAanleverService.aanleverenRequest();
            inValue.aanleverRequest = aanleverRequest;
            return ((BivConnection.CSAanleverService.AanleverService_V1_2)(this)).aanleverenAsync(inValue);
        }
    }
}
